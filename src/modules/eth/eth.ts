...
const AOPurchaseReceipt = require("ao-contracts/build/minified/AOPurchaseReceipt.json");
const AOContent = require("ao-contracts/build/minified/AOContent.json");
const AOContentHost = require("ao-contracts/build/minified/AOContentHost.json");
const AOStakedContent = require("ao-contracts/build/minified/AOStakedContent.json");
